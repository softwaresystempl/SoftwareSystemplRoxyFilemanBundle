...
class ConfController extends Controller
{
    ...
    protected function getProfileParameter($profile, $parameter){
        if ($profile === null) {
            return $this->container->getParameter('softwaresystem_roxyfileman.conf.' . $parameter);
        }
        return $this->container->getParameter('softwaresystem_roxyfileman.'. $profile .'.conf.' . $parameter);
    }
}
