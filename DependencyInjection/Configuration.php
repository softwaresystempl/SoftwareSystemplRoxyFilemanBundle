...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode = $treeBuilder->root('softwaresystem_roxy_fileman');
        ...
        return $this->createNode('conf')
            ...
            ->children()
                ...
                ->scalarNode('dirlist_route')
                    ->defaultValue('softwaresystem_roxyfileman_dir_list')
                    ->cannotBeEmpty()
                ->end()
                ->scalarNode('createdir_route')
                    ->defaultValue('softwaresystem_roxyfileman_create_dir')
                    ->cannotBeEmpty()
                ->end()
                ->scalarNode('deletedir_route')
                    ->defaultValue('softwaresystem_roxyfileman_delete_dir')
                    ->cannotBeEmpty()
                ->end()
                    ->scalarNode('movedir_route')
                    ->defaultValue('softwaresystem_roxyfileman_move_dir')
                ->cannotBeEmpty()
                ->end()
                ->scalarNode('copydir_route')
                    ->defaultValue('softwaresystem_roxyfileman_copy_dir')
                    ->cannotBeEmpty()
                ->end()
                ->scalarNode('renamedir_route')
                    ->defaultValue('softwaresystem_roxyfileman_rename_dir')
                    ->cannotBeEmpty()
                ->end()
                ->scalarNode('fileslist_route')
                    ->defaultValue('softwaresystem_roxyfileman_file_list')
                    ->cannotBeEmpty()
                ->end()
                ->scalarNode('upload_route')
                    ->defaultValue('softwaresystem_roxyfileman_upload')
                    ->cannotBeEmpty()
                ->end()
                ->scalarNode('download_route')
                    ->defaultValue('softwaresystem_roxyfileman_download')
                    ->cannotBeEmpty()
                ->end()
                ->scalarNode('downloaddir_route')
                    ->defaultValue('softwaresystem_roxyfileman_download_dir')
                    ->cannotBeEmpty()
                ->end()
                ->scalarNode('deletefile_route')
                    ->defaultValue('softwaresystem_roxyfileman_delete_file')
                    ->cannotBeEmpty()
                ->end()
                ->scalarNode('movefile_route')
                    ->defaultValue('softwaresystem_roxyfileman_move_file')
                    ->cannotBeEmpty()
                ->end()
                ->scalarNode('copyfile_route')
                    ->defaultValue('softwaresystem_roxyfileman_copy_file')
                    ->cannotBeEmpty()
                ->end()
                ->scalarNode('renamefile_route')
                    ->defaultValue('softwaresystem_roxyfileman_rename_file')
                    ->cannotBeEmpty()
                ->end()
                ->scalarNode('generatethumb_route')
                    ->defaultValue('softwaresystem_roxyfileman_generate_thumb')
                    ->cannotBeEmpty()
                ->end()
